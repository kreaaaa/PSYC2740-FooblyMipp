...
```
There are 197 unique subjects but only have complete data for 193 participants.
...
```
Mean age is 34.98 years old with a standard deviation of 15.38. (M = 34.98, SD = 15.38)
Gender distribution: Women (n = 102), Men (n = 90), Nonbinary (n = 2)
Race distribution: Asian (n = 10), Black/African American (n = 36), Other (n = 8), White/Caucasian (n = 132), Multiracial (n = 11)
Education distribution: 5 years (n = 1), 7 years (n=1),8 years (n = 1), 9 years (n=1),10 years (n = 3), 11 years (n = 2), 12 years (n = 47), 13 years, (n = 18), 14 years (n = 20), 15 years (n = 19), 16 years (n = 43), 17 years (n = 17), 18 years (n = 11), 19 years (n = 4), 20 years (n = 6), 21 years (n = 1), 24 years (n = 1), 27 years (n = 1). 
...
```
Average accuracy for target trials (not practice trials) with no exclusions (M = 0.89, SD = 0.32)
...
- how many participants' data are analyzed for priming: 137  participants' data are analyzed in our priming model (70 non-rhyming and 67 rhyming)
...
The model revealed a significant main effect of relatedness (χ² (1, N = 3796)= 37.16, p < 0.001), suggesting that relatedness significantly influenced reaction times. The effect of condition was not significant (χ² = (1, N = 3796) = 3.11, p = 0.078),suggesting a potential influence of condition. The significant interaction between relatednesss and condition (χ² = (1, N = 3796) = 13.18, p < 0.001) suggests that the effect of relatedness on reaction time is moderated by the condition.
