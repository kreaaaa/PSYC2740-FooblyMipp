...
Subjects completed different numbers of trials because of either slow responses to target trials or ____
...
- how many did not finish the game
- how many were excluded based on ALL pre-registered criteria
- how many participants' data are analyzed for priming: 87 participants' data are analyzed in our priming model 
...
```
For relatedness χ² = 0.844, df = 3, p < 0.001, INCORRECT recording of p-value, state actual p value -- think i fixed it 
based on slides, it should be  χ²(3, N= nobs(19651)) = 0.844, p< .001 
For condition χ² = 3.21, df = 1, p = 0.073 -- need df and N 
...
# checking to see how many unique values w prof kumar 
```{r}
